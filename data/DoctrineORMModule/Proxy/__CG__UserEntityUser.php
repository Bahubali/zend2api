...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'User\\Entity\\User' . "\0" . 'id', '' . "\0" . 'User\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'User\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'User\\Entity\\User' . "\0" . 'email', '' . "\0" . 'User\\Entity\\User' . "\0" . 'password', '' . "\0" . 'User\\Entity\\User' . "\0" . 'createDtTm', '' . "\0" . 'User\\Entity\\User' . "\0" . 'updateDtTm', '' . "\0" . 'User\\Entity\\User' . "\0" . 'deleteFlag', '' . "\0" . 'User\\Entity\\User' . "\0" . 'comments');
        }
    ...
    public function setCreateDtTm($createDtTm)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCreateDtTm', array($createDtTm));

        return parent::setCreateDtTm($createDtTm);
    }
    ...
    public function getCreateDtTm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCreateDtTm', array());

        return parent::getCreateDtTm();
    }
    ...
    public function setUpdateDtTm($updateDtTm)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUpdateDtTm', array($updateDtTm));

        return parent::setUpdateDtTm($updateDtTm);
    }
    ...
    public function getUpdateDtTm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUpdateDtTm', array());

        return parent::getUpdateDtTm();
    }
